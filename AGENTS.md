...
- Verification skills: `simulator-testing` (build/launch smoke verification via `.opencode/scripts/xcode-tools.sh`), `swift-review` (local app-code review), `design-review` (design-doc review vs `docs/template/design.md` + `.opencode/rules/004-accessibility.md`)
...
5. If the user's answer shows a conflict with `docs/specs/spec-guide.md`/`docs/designs/`/`docs/implementation.md`, surface it and let the user decide which wins.
...
| Feature work (what/how it must be) | `docs/specs/spec-guide.md`, `docs/designs/`, `docs/implementation.md` |
