...
- Verification skills: `simulator-testing` (build/launch smoke verification via `.opencode/scripts/xcode-tools.sh`), `swift-review` (local app-code review), `design-review` (design-doc review vs `docs/design.md` + `.opencode/rules/004-accessibility.md`)
